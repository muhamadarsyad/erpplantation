    ...
    <div class="auth-inner row m-0">
        ...
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                ...
                <p class="card-text mb-2">Login disini untuk memulai</p>
                <form class="auth-login-form mt-2" action="{{url('auth/post-login')}}" method="POST">
                    @csrf
                    <div class="mb-1">
                ...
                <p class="text-center mt-2">
                    ...
                    <a href="{{url('auth/register-cover')}}"><span>&nbsp;Daftar disini</span></a>
                </p>
            </div>
        </div>
        <!-- /Login-->
