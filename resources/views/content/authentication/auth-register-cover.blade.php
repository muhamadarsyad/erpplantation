    ...
    <div class="auth-inner row m-0">
        ...
        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                <h2 class="card-title fw-bold mb-1">ERP Plantation</h2>
                <p class="card-text mb-2">Registrasi</p>
                <form class="auth-register-form mt-2" action="{{url('auth/post-registration')}}" method="POST" id="regForm">
                    @csrf
                    <div class="mb-1">
                        <label class="form-label" for="register-username">Nama Pengguna</label>
                        <input class="form-control" id="register-username" type="text" name="username"
                    ...
                    <button class="btn btn-primary w-100" tabindex="5" type="submit">Daftar</button>
                </form>
                <p class="text-center mt-2">
                    <span>Sudah punya akun?</span>
                    <a href="{{url('auth/login-cover')}}"><span>&nbsp;Login ke sini</span></a>
                </p>
            </div>
        </div>
        <!-- /Register-->
